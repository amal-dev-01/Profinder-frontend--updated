...
export default function Profileview() {
    ...
    const blockUser = async (pk) => {
        try {
            const response = await axiosInstance.put(`adminpanel/details_view/${pk}/`,
              {},
              {
                headers: {
                  Authorization: `Bearer ${authToken}`,
                                ...
                                <div style={{ backgroundColor: "#f8f9fa", padding: "2%", textAlign: "left", alignItems: "center", marginRight: "3%" }}>
                                    ...
                                    <div>
                                        ...
                                        <div>{user.is_active?
                                            ...
                                            <Button onClick={() => blockUser(user.id)}>Unblock</Button>
                                            
                                            }
                                            {user.is_professional === true &&  user.is_user === false ?
